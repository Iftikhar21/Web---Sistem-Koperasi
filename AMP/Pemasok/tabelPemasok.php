            ...
            <?php
                for($i = 0; $i < $jumlah; $i++){
                    ...
                    <tr>
                        ...
                        <?php if($_SESSION['level'] == "admin"): ?>
                            <td>
                                <a href="../Pemasok/formUpdatePemasok.php?kode_pemasok=<?= $row["kode_pemasok"] ?>" name="update" class="btn btn-success">Update</a>
                                <a href="../Pemasok/deletePemasok.php?kode_pemasok=<?= $row["kode_pemasok"] ?>" name="delete" class="btn btn-danger">Delete</a>
                            </td>
                        <?php endif; ?>
                    </tr>
                    <?php
