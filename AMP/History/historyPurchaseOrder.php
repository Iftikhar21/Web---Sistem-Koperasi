<?php
    ...
    $sql = "SELECT * from transaksi_koperasi";
...
<div class="main-table">
    <h3 class="mb-3">Tabel Laporan Re-Stock</h3>
                    ...
                    <tr>
                        ...
                        <?php
                            if($row["status"] == "Pending"){ ?>
                                <td>
                                    <span class="badge text-bg-secondary p-2"><?=$row["status"]?></span>
                                </td>
                            <?php } else if ($row["status"] == "Requested") { ?>
                                <td>
                                    <span class="badge text-bg-warning p-2"><?=$row["status"]?></span>
                                </td>
                            <?php } else if ($row["status"] == "Approved") { ?>
                                <td>
                                    <span class="badge text-bg-success p-2"><?=$row["status"]?></span>
                                </td>
                            <?php } else { ?>
                                <td>
                        ...
                        <!-- <?php if($_SESSION['level'] == "admin"): ?>
                            <td>
                                <a href="../Pelanggan/formUpdatePelanggan.php?kode_pelanggan=<?= $row["kode_barang"] ?>" name="update" class="btn btn-success">Update</a>
                                <a href="../Pelanggan/deletePelanggan.php?kode_pelanggan=<?= $row["kode_barang"] ?>" name="delete" class="btn btn-danger">Delete</a>
                            </td>
                        <?php endif; ?> -->
                    </tr>
                    <?php
